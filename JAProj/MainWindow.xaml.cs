...
namespace JAProj {
    public partial class MainWindow : Window {
        [DllImport(@"JACpp.dll")] static unsafe private extern void passImageToCpp(byte* InputArray, byte* OutputArray, int width, int height, int start, int stop);
        [DllImport(@"JAAsm.dll")] static unsafe private extern void passImageToAsm(byte* InputArray, byte* OutputArray, int width, int height, int start, int stop);
